...
{
    public class TimeRepository : AdoRepository, ITimeRepository
    {
        /// <summary>
        ...
        /// </param>
        public TimeRepository(IConfiguration config, IHttpContextAccessor httpContextAccesor)
            : base(config, httpContextAccesor, database: "TimePro", TimeSpan.FromMinutes(1))
        {
